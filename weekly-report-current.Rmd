...
<!-- INSERT ADDITIONAL TEXT BELOW THIS LINE -->
The 1st of March witnessed high traffic of tweets and retweets compared to other days of thweek under review
<!-- DO NOT ENTER TEXT BELOW THIS LINE -->
...
### 2.0 Observations  
<!-- INSERT ADDITIONAL TEXT BELOW THIS LINE -->
The Agency's twitter presence and following is strong. It is important that the work and success so far enjoyed via twitter is replicated across other social media platforms
<!-- DO NOT ENTER TEXT BELOW THIS LINE -->

### 3.0 Recommendation  
<!-- INSERT ADDITIONAL TEXT BELOW THIS LINE -->
Based on the observation, it is recommended that the Agency integrate social media response time into their work plan. It is very important that responses from from the Agency to questions or queries are given within a 24-hour time frame.
<!-- DO NOT ENTER TEXT BELOW THIS LINE -->
 
**END**.  

###### *Technical information*  
Data were accessed via an application programming interface (API) and analysed with R, a programming language used mainly for statistical computing.[^3] This document was generated with R Markdown to allow for programmmatic rendering of all the outputs.[^4] The complete code for a generic version of this report can be viewed and/or downloaded  **[here](https://raw.githubusercontent.com/NESREA/NESREA_social/master/weekly-report-generic.Rmd)**. Permissions apply.
...
[^2]: A Sentiment Analysis was carried out using the sentiment dictionary (Hu and Liu, 2004) to tag polarised words. Context clusters are then developed, as well use of the ‘bag of words’ method, generate plots to visualize ‘emotional valence’.
[^3]: The R Programming Language for Statistical Computing (Version `r getRversion()`) was used for all the analyses. <http://r-project.org>
[^4]: This document is generated with R Markdown (version `r packageVersion("rmarkdown")`).