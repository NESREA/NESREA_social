...
The data are downloaded via access to the application programming interface (API)  of the respective sites and analysed with the R programming language.[^1] This document was generated with R Markdown to allow programmmatic rendering of outputs.[^2] For details on the source code used can be obtained at the Agency's [GitHub repository](http://github.com/NESREA/NESREA_social).
