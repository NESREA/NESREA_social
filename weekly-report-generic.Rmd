...
last_wk <- filter(all_data, date_only >= "2017-02-07" & date_only <= "2017-02-21")
...
|Comparative tweet volume (week-on-week)| `r nrow(wk_data) - nrow(last_wk)`|
|                                       |                                  |
<!--
