...
Below, is a representation of the previous plot, with the data disaggregated by days in order to display relative Twitter activity during the week under review.[^2]  
```{r daily tweets plot}  
simplePlot +
  facet_grid(day ~ .) +
  theme(axis.text.y = element_blank(), axis.ticks.y = element_blank())
...
[^2]: Note that days with no data are automatically dropped
[^3]: R is a programming language as well as an environment for statistical computing (<http://r-project.org>)
